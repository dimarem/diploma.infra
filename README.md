...
4. На странице "DNS-серверы и управление зоной" нажать "Добавить запись" и выбрать CNAME.
5. В открывшейся форме ввести значения:
  - Subdomain: _acme-challenge
  - Canonical name: dns_value (например, "fpqu3rctnmtkbja010e9.cm.yandexcloud.net.")
  - TTL: 3600
6. Нажать "Готово".
